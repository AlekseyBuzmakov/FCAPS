...
const char FisherBinClassificationOptimisticEstimator[] = "FisherBinClassificationOptimisticEstimator";

////////////////////////////////////////////////////////////////////

class CFisherBinClassificationOEst : public IOptimisticEstimator, public IModule {
public:
	CFisherBinClassificationOEst();
	...
	virtual JSON GetJsonQuality(const IExtent* ext) const {return "";}
	...
	static const char* const Name()
		{ return FisherBinClassificationOptimisticEstimator; }
	static const char* const Desc();

private:
	static const CModuleRegistrar<CFisherBinClassificationOEst> registrar;
	...
	// For efficient Fisher test computation
	double *loggamma;
