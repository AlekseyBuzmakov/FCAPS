...
public:
	...
	// Get/Set ignoring when not close
	bool GetIgnoreIfNotClose() const
		{ return ignoreIfNotClose; }
	void SetIgnoreIfNotClose(bool value)
		{ ignoreIfNotClose = value; }
...
private:
	...
	DWORD attrNumLimit;
	// Ignore computation and return minimum stab if not close
	bool ignoreIfNotClose;
